...
contract Ownable {
    ...
    {
        require(msg.sender == _owner, "Access denied: Not the contract owner.");
        _;
    }
...
contract Pausable is Ownable {
    ...
    event Paused (address indexed byAddress);
    event Unpaused (address indexed byAddress);
    ...
    modifier whenNotPaused () {
        require (!_paused, "Contract must be active but is paused.");
        _;
    }
    modifier paused () {
        require (_paused, "Contract must be paused but is active.");
        _;
    }
}
...
contract ERC165 {
    ...
    function _registerInterface(bytes4 interfaceId) internal {
        require(interfaceId != 0xffffffff, "Must be valid interfaceId");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Not the token owner: Please provide the correct address.");
        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((msg.sender == Ownable.getOwner()) || isApprovedForAll(owner, msg.sender), "Not authorized to approve transfers.");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Owner cannot appoint herself as an operator.");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), "Check failed");
    }
...
contract Capstones is ERC721Metadata("Capstones", "CAP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
